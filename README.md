...
- TensorBoard logs are written under `runs/` in the current repository, and each launch gets an independent run subdirectory containing `scalars.tsv` plus event files.
